  ...
  const tools = [
    {
      ...
      description:
        "Сравнить три проверенные стратегии: общий Score, слабейший район, бюджетный резерв. Все наборы валидны. Поиск ограничен заменой или переносом одного решения.",
...
Ссылки evidenceId в risks обязаны совпадать с id из inspect_risks (у рисков стратегий есть префикс стратегии). Причины риска объясняй через соответствующий показатель.
Результат — условная модель, не статистика реальной Астаны и не доказанный прогноз. Вероятности кризисов и мнения жителей отсутствуют. Не выдумывай их. Поиск альтернатив локальный, поэтому не называй результат глобально лучшим.
