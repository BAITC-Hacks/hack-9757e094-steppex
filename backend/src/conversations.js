...
export const clarificationMessage = 'Что важнее сейчас: повысить общий Score, помочь самому слабому району или сохранить бюджетный резерв? Выберите приоритет ниже или напишите свой вопрос.';
